...
export const BUILT_IN_LANGUAGES: Record<string, { name: string; flag: string; translations: TranslationDict }> = {
  ...
  ma10Expl: 'Compares the price with its average over the last 10 trading days. Above it points to short-term upward momentum; below it, short-term weakness.',
  ...
  ma10Expl: '比较当前价格与过去10个交易日的均价。高于均价代表短线动能向上，低于则代表短线走弱。',
  ...
  ma10Expl: 'Compara el precio actual con su media de los últimos 10 días. Por encima sugiere impulso alcista a corto plazo; por debajo, debilidad.',
  ...
  ma10Expl: '現在価格と過去10営業日の平均値を比較。平均を上回れば短期的な上昇モメンタム、下回れば弱気のサインです。',
  ...
  ma10Expl: 'Compare le prix actuel à sa moyenne des 10 derniers jours. Au-dessus, momentum haussier court terme ; en dessous, faiblesse.',
  ...
  de: {
    ...
    translations: {
      ...
      ma10Expl: 'Vergleicht den Kurs mit dem Durchschnitt der letzten 10 Handelstage. Darüber: kurzfristiges Aufwärtsmomentum; darunter: Schwäche.',
